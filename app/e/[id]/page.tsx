      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <aside className="space-y-4">
            ...
            <a
              href={`/api/v1/events/${encodeURIComponent(event.uri)}/ical`}
              className="flex items-center justify-center gap-2 rounded-lg py-2 text-sm font-medium text-ink-2 ring-1 ring-hairline hover:bg-sunken transition-colors"
            >
